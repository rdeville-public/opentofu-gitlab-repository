...
# Contributing to OpenTofu Module Gitlab Repository
...
[bug_tracker_opened_issues]: https://framagit.org/rdeville-public/opentofu/gitlab-repository/issues/?sort=created_date&state=opened&or[label_name][]=Type%3A%3ABug&or[label_name][]=Type%3A%3ARegression&first_page_size=200
...
OpenTofu Module Gitlab Repository, **including completely new features and minor improvements to
...
[issues_page]: https://framagit.org/rdeville-public/opentofu/gitlab-repository/-/issues
...
- You may want to **include screenshots or screen recordings** which help you
  ...
  instance).
- **Explain why this enhancement would be useful** to most OpenTofu Module Gitlab Repository users. You
...
[new_issues_page]: https://framagit.org/rdeville-public/opentofu/gitlab-repository/-/issues/new
...
```text
[OpenTofu Module Gitlab Repository] - Join The Project Team
```
...
[README]: https://framagit.org/rdeville-public/opentofu/gitlab-repository/-/blob/main/README.md
[CODE_OF_CONDUCT]: https://framagit.org/rdeville-public/opentofu/gitlab-repository/-/blob/main/CODE_OF_CONDUCT.md
[documentation]: https://framagit.org/rdeville-public/opentofu/gitlab-repository
